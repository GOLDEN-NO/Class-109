...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		print("Distance: ",dist)
		print("Computer Screen Size: ",screen_width,screen_height,"Output Window",width,height)
		print("Mouse Position: ",mouse.position,"Tips Line Center Positions: ",center_x,center_y)
